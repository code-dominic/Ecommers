...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  ...
  return [isProp ? propValue : stateValue, (0, import_react34.useCallback)((...args) => {
...
var Switch = React76.forwardRef((props, ref) => (0, import_jsx_runtime69.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var RTGTransition = React86.forwardRef((_ref, ref) => {
  let {
...
var Modal = (0, import_react69.forwardRef)((_ref, ref) => {
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime81.jsx)("div", Object.assign({}, dialogProps, {
    children: React88.cloneElement(children, {
      role: "document"
    })
  }));
...
var ModalBody = React89.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ModalContext = React90.createContext({
  onHide() {
  }
});
...
var ModalDialog = React91.forwardRef(({
  bsPrefix,
  className,
  contentClassName,
  centered,
...
var ModalFooter = React92.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var AbstractModalHeader = React93.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
...
var ModalHeader = React94.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var ModalTitle = React95.forwardRef(({
  className,
  bsPrefix,
...
var NavItem2 = React97.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var NavLink = React98.forwardRef(({
  bsPrefix,
  className,
  as: Component2 = Anchor_default,
  active,
...
var Nav2 = React99.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
    bsPrefix: initialBsPrefix,
    variant,
...
var NavbarBrand = React100.forwardRef(({
  bsPrefix,
  className,
  as,
  ...props
...
var NavbarCollapse = React101.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
...
var NavbarToggle = React102.forwardRef(({
  bsPrefix,
  className,
  children,
...
var OffcanvasBody = React103.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OffcanvasToggling = React104.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
  ...
  return (0, import_jsx_runtime97.jsx)(TransitionWrapper_default, {
    ...
    ...props,
    childRef: getChildRef(children),
    children: (status, innerProps) => React104.cloneElement(children, {
      ...innerProps,
...
var OffcanvasHeader = React105.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var OffcanvasTitle = React106.forwardRef(({
  className,
  bsPrefix,
...
var Offcanvas = React107.forwardRef(({
  bsPrefix,
  className,
  children,
  "aria-labelledby": ariaLabelledby,
...
var NavbarOffcanvas = React108.forwardRef(({
  onHide,
  ...props
}, ref) => {
...
var NavbarText = React109.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var Navbar = React110.forwardRef((props, ref) => {
  const {
    bsPrefix: initialBsPrefix,
    expand = true,
    variant = "light",
...
var NavDropdown = React111.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React112.forwardRef((props, outerRef) => {
  const {
    flip: flip2,
    offset: offset2,
    placement,
...
var PopoverHeader = React113.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var PopoverBody = React114.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Popover = React116.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style: style2,
...
var Overlay2 = React118.forwardRef(({
  children: overlay,
  transition = Fade_default,
  popperConfig = {},
  rootClose = false,
  ...
  return (0, import_jsx_runtime114.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React118.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper: popper2,
...
var OverlayTrigger = ({
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React119.Children.only(children).props : {};
  const attachRef = (r) => {
    mergedRef(safeFindDOMNode(r));
  };
...
var PageItem = React120.forwardRef(({
  active = false,
  disabled = false,
  className,
  style: style2,
...
function createButton(name, defaultValue, label = name) {
  const Button = React120.forwardRef(({
    children,
    ...props
...
var PlaceholderButton = React122.forwardRef((props, ref) => {
...
var Placeholder = React123.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
var ProgressBar = React124.forwardRef(({
  isChild = false,
  ...rest
}, ref) => {
  const props = {
...
var Ratio = React125.forwardRef(({
  ...
  return (0, import_jsx_runtime124.jsx)("div", {
    ...
    children: React125.Children.only(children)
  });
});
...
var ToastFade = React136.forwardRef((props, ref) => (0, import_jsx_runtime138.jsx)(Fade_default, {
  ...props,
  ref,
