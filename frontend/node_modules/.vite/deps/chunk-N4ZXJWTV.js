...
function forEach(children, func) {
  ...
  React2.Children.forEach(children, (child) => {
    if (React2.isValidElement(child)) func(child, index++);
  });
}
...
var ButtonGroup = React3.forwardRef(({
  bsPrefix,
  size,
  vertical = false,
  className,
...
var ToggleButtonGroup = React4.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
...
//# sourceMappingURL=chunk-N4ZXJWTV.js.map
